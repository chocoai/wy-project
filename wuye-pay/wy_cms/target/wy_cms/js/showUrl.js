...
//	                       }  
//	                   }},
		         {field:'urlkey',title:'商户key',width:80,halign:'center',sortable:false,editor:"text"},
		         {field:'urlname',title:'公司名称',width:120,halign:'center',sortable:false,editor:"text"},
		         {field:'urlstring',title:'接口定义',width:250,halign:'center',sortable:false,editor:"text"},
		         {field:'soapactionstring',title:'SoapAction',width:250,halign:'center',sortable:false,editor:"text"},
		         {field:'secretkey',title:'商户密钥',width:150,halign:'center',sortable:false,editor:"text"},
		...
		onAfterEdit : function(rowIndex, rowData, changes) {
			...
			var url;
			if (flag == "add") {
				url = "url/saveUrlMap.htm";
			} else {
				url = "url/updateUrlMap.htm";
			}
			// endEdit该方法触发此事件
			editRow = undefined;
			jQuery.ajax({
	...
	$("#btnSearch").click(function(){
		...
		var soapactionstring = $("#soapactionstring").val();
		var parameters = {
				urlkey:urlkey,
				urlstring:urlstring,
