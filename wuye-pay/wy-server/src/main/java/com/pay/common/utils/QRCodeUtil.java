...
public class QRCodeUtil {
	 ...
	 * @throws Exception
	 */
	public static String encode2Base64(String content) throws Exception {
	...
	/**
	 * 二维码字符串输出为图像base64编码,带有图片头信息
	 * 
	 * @param content
	 * @return
	 * @throws Exception
	 */
	public static String encode2ImgBase64(String content) throws Exception {
		ByteArrayOutputStream bos = new ByteArrayOutputStream();
		encode(content, bos);
		return "data:image/png;base64," + Encodes.encodeBase64(bos.toByteArray());
	}
	...
	public static void main(String[] args) throws Exception {
		...
		// 不含Logo
		QRCodeUtil.encode(text, null, "D:\\qrTest", true);
		// 含Logo，不指定二维码图片名
