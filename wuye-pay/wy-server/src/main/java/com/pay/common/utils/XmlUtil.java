...
public class XmlUtil {
	 ...
	 * @throws IOException
	 */
	public static Document map2xml2(Map<String, String> map, String rootName) throws DocumentException, IOException {
		Document doc = DocumentHelper.createDocument();
		Element root = DocumentHelper.createElement(rootName);
		doc.add(root);
		map2xml2(map, root);
	 ...
	 * @throws IOException
	 */
	public static String map2xml2(Map<String, String> map) throws DocumentException, IOException {
		return formatXml(map2xml2(map, "xml")).replaceAll(" ", "").replaceAll("\\r", "").replaceAll("\\n", "");
	}
